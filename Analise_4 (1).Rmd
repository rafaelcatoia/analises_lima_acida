...
## Rhizotron {.tabset}
```{r}
dframe_rhiz = data.table::fread("/Users/rafaelcatoia/My Drive/08_Consultorias/01_Ana_Julia/04_Projeto4/Dados/Rizhotron.txt")
...
```{r}
dframe_dv = data.table::fread("/Users/rafaelcatoia/My Drive/08_Consultorias/01_Ana_Julia/04_Projeto4/Dados/DesenvVegetativo.txt")
...
```{r}
dframe_qf = data.table::fread("/Users/rafaelcatoia/My Drive/08_Consultorias/01_Ana_Julia/04_Projeto4/Dados/QualidadeFruto.txt")
